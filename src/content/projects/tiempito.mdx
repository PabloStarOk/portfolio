...
<ProjectSectionLayout title="Desafíos">
  ...
  <p slot="situation">Las diferencias de gestión de las notificaciones en Linux y Windows represento mayormente la creación de un diseño que permitiese estructurar e inyectar las dependencias únicamente necesarias de acuerdo con el sistema operativo.</p>
  <p slot="solution">A través de las directivas de preprocesador y clases utilitarias ofrecidas por .NET se inyectaron dinamicamente las interfaces y clases para Windows o Linux.</p>
